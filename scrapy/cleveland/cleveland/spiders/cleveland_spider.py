...
from cleveland.items import ClevelandItem
import datetime
from dateutil import parser

class ClevelandSpider(CrawlSpider):
    name = 'cleveland'
    allowed_domains = ["cleveland.craigslist.org"]
    base_url = "http://cleveland.craigslist.org"
    start_urls = ["http://cleveland.craigslist.org/search/apa?srchType=T&bedrooms=1&bathrooms=1"]
    rules = [
