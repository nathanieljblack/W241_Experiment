...
from craigslist_dc_apts.items import CraigslistDcAptsItem
import datetime
from dateutil import parser

class CraigslistDcAptsSpider(CrawlSpider):
    name = 'craigslist_dc_apts'
    allowed_domains = ["washingtondc.craigslist.org"]
    base_url = "http://washingtondc.craigslist.org"
    start_urls = ["http://washingtondc.craigslist.org/search/doc/apa?srchType=T&bedrooms=1&bathrooms=1"]
    rules = [
